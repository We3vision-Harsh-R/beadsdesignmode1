...
const AUTH_MESSAGES = {
  ...
  'Email logins are disabled': 'Login is not turned on yet. Please contact the site admin.',
  'Email signups are disabled': 'Sign up is not turned on yet. Please contact the site admin.',
